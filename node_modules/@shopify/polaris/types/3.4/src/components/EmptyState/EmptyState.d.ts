...
export declare function EmptyState({ children, heading, image, largeImage, imageContained, centeredLayout, action, secondaryAction, footerContent, }: EmptyStateProps): JSX.Element;
