...
if (typeof window !== 'undefined') {
  ...
  window.Polaris.VERSION = '4.22.0';
}

var polarisVersion = '4.22.0';
...
function buildThemeContext(themeConfig, cssCustomProperties) {
  ...
  var topBar = colors.topBar,
      newDesignLanguageColors = tslib.__rest(colors, ["topBar"]);
...
var getUniqueID = other.createUniqueIDFactory('portal-');
var Portal = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(Portal, [{
    ...
    value: function render() {
      return this.portalNode && this.state.isMounted ? reactDom.createPortal(this.props.children, this.portalNode) : null;
    }
  }]);
  ...
  _createClass(Scrollable, [{
    ...
    value: function render() {
      ...
      var _a = this.props,
          ...
          rest = tslib.__rest(_a, ["children", "className", "horizontal", "vertical", "shadow", "hint", "onScrolledToBottom"]);
    ...
    value: function forNode(node) {
      var closestElement = dom.closest(node, scrollable.selector);
  ...
  _createClass(EventListener, [{
    ...
    value: function componentDidUpdate(_a) {
      var passive = _a.passive,
          detachProps = tslib.__rest(_a, ["passive"]);
...
function KeypressListener(_ref) {
  ...
  React.useEffect(function () {
    events.addEventListener(document, keyEvent, handleKeyEvent);
    return function () {
      events.removeEventListener(document, keyEvent, handleKeyEvent);
    };
  });
  return null;
}
  ...
  function PositionedOverlay(props) {
    ...
    _this.handleMeasurement = function () {
      ...
      _this.setState(function (_ref) {
        ...
        var activatorRect = geometry.getRectForNode(preferredActivator);
...
var PopoverOverlay = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function PopoverOverlay() {
    ...
    _this.handleClick = function (event) {
      ...
      var isDescendant = contentNode.current != null && dom.nodeContainsDescendant(contentNode.current, target);
...
var Popover = function Popover(_a) {
  var _a$activatorWrapper = _a.activatorWrapper,
      ...
      rest = tslib.__rest(_a, ["activatorWrapper", "children", "onClose", "activator", "active", "fixed", "ariaHaspopup", "preferInputActivator"]);
  ...
  var setAccessibilityAttributes = React.useCallback(function () {
...
function Section$1(_ref) {
  ...
  var actionMarkup = section.items.map(function (_a, index) {
    var content = _a.content,
        ...
        item = tslib.__rest(_a, ["content", "helpText", "onAction"]);
...
function Button(_ref) {
  ...
  var toggleDisclosureActive = React.useCallback(function () {
...
var Stack = React.memo(function Stack(_ref) {
  var children = _ref.children,
...
function Header(_ref) {
  ...
  var titleMarkup = React__default.isValidElement(title) ? title : /*#__PURE__*/React__default.createElement(Heading, null, title);
      ...
      var actionMarkup = overriddenActions.map(function (action, index) {
        if ('title' in action) {
          var title = action.title,
              ...
              _rest = tslib.__rest(action, ["title", "actions"]);
        ...
        var content = action.content,
            rest = tslib.__rest(action, ["content"]);
...
function ThemeProvider(_ref) {
  ...
  var colors = themeConfig.colors,
      colorScheme = themeConfig.colorScheme,
      rest = tslib.__rest(themeConfig, ["colors", "colorScheme"]);
  ...
  var customProperties = React.useMemo(function () {
...
var MediaQueryProvider = function MediaQueryProvider(_ref) {
  ...
  var _useState = React.useState(navigationBarCollapsed().matches),
      _useState2 = _slicedToArray(_useState, 2),
...
function FocusManager(_ref) {
  ...
  var add = React.useCallback(function (id) {
...
function OptionList(_ref) {
  ...
  var _useState = React.useState(createNormalizedOptions(options, sections, title)),
      _useState2 = _slicedToArray(_useState, 2),
  ...
  var handleClick = React.useCallback(function (sectionIndex, optionIndex) {
...
function ComboBox(_ref) {
  ...
  var getActionsWithIds = React.useCallback(function (actions, before) {
    if (before) {
  ...
  var visuallyUpdateSelectedOption = React.useCallback(function (newOption, oldOption) {
    if (oldOption) {
  ...
  var resetVisuallySelectedOptions = React.useCallback(function () {
    setSelectedIndex(-1);
    navigableOptions.forEach(function (option) {
      option.active = false;
    });
  }, [navigableOptions]);
  var selectOptionAtIndex = React.useCallback(function (newOptionIndex) {
  ...
  var selectNextOption = React.useCallback(function () {
    if (navigableOptions.length === 0) {
      return;
    }
  ...
  var selectPreviousOption = React.useCallback(function () {
    if (navigableOptions.length === 0) {
      return;
    }
  ...
  var selectOptions = React.useCallback(function (selected) {
  ...
  var handleSelection = React.useCallback(function (newSelected) {
  ...
  var updateIndexOfSelectedOption = React.useCallback(function (newOptions) {
    var selectedOption = navigableOptions[selectedIndex];
...
function Labelled(_a) {
  var id = _a.id,
      ...
      rest = tslib.__rest(_a, ["id", "label", "error", "action", "helpText", "children", "labelHidden"]);
...
function Resizer(_ref) {
  ...
  var handleHeightCheck = React.useCallback(function () {
    if (animationFrame.current) {
      cancelAnimationFrame(animationFrame.current);
    }
...
function TextField(_ref) {
  ...
  var _useState3 = React.useState(Boolean(focused)),
      _useState4 = _slicedToArray(_useState3, 2),
      focus = _useState4[0],
  ...
  var handleNumberChange = React.useCallback(function (steps) {
    if (onChange == null) {
      return;
  ...
  var handleButtonRelease = React.useCallback(function () {
    clearTimeout(buttonPressTimer.current);
  }, []);
  var handleButtonPress = React.useCallback(function (onChange) {
    var minInterval = 50;
    var decrementBy = 10;
    var interval = 200;
    ...
    buttonPressTimer.current = window.setTimeout(onChangeInterval, interval);
    events.addEventListener(document, 'mouseup', handleButtonRelease, {
      once: true
    });
  }, [handleButtonRelease]);
  ...
  var handleExpandingResize = React.useCallback(function (height) {
    setHeight(height);
  }, []);
...
var ParentCollapsibleExpandingContext = React.createContext(false);
...
var CollapsibleInner = /*#__PURE__*/function (_React$Component) {
  ...
  function CollapsibleInner() {
    ...
    _this.heightNode = React.createRef();
...
var Day = React.memo(function Day(_ref) {
  var day = _ref.day,
      focused = _ref.focused,
      onClick = _ref.onClick,
  ...
  var ariaLabel = ["".concat(today ? i18n.translate('Polaris.DatePicker.today') : ''), "".concat(dates.Months[day.getMonth()], " "), "".concat(date, " "), "".concat(day.getFullYear())].join('');
  return /*#__PURE__*/React__default.createElement("button", {
...
function Month(_ref) {
  ...
  var weeks = React.useMemo(function () {
    return dates.getWeeksForMonth(month, year, weekStartsOn);
  ...
  var handleDateClick = React.useCallback(function (selectedDate) {
    onChange(dates.getNewRange(allowRange ? selected : undefined, selectedDate));
  }, [allowRange, onChange, selected]);
  var lastDayOfMonth = React.useMemo(function () {
  ...
  function renderWeek(day, dayIndex) {
    ...
    var isLastSelectedDay = allowRange && selected && (!dates.isSameDate(selected.start, selected.end) && isDateEnd(day, selected) || hoverDate && dates.isSameDate(selected.start, selected.end) && dates.isDateAfter(hoverDate, selected.start) && dates.isSameDay(day, hoverDate) && !isFirstSelectedDay);
    var rangeIsDifferent = !(selected && dates.isSameDate(selected.start, selected.end));
    var isHoveringRight = hoverDate && dates.isDateBefore(day, hoverDate);
    return /*#__PURE__*/React__default.createElement(Day, {
...
function DatePicker(_ref) {
  var id = _ref.id,
      ...
      weekStartsOn = _ref$weekStartsOn === void 0 ? dates.Weekdays.Sunday : _ref$weekStartsOn,
  ...
  var handleFocus = React.useCallback(function (date) {
    setFocusDate(date);
  }, []);
  var setFocusDateAndHandleMonthChange = React.useCallback(function (date) {
    if (onMonthChange) {
  ...
  var handleDateSelection = React.useCallback(function (range) {
    var end = range.end;
    setHoverDate(end);
    setFocusDate(new Date(end));
    onChange(range);
  }, [onChange]);
  var handleMonthChangeClick = React.useCallback(function (month, year) {
    if (!onMonthChange) {
      return;
    }
  ...
  var handleHover = React.useCallback(function (date) {
    setHoverDate(date);
  }, []);
  ...
  var monthIsSelected = React.useMemo(function () {
...
function FileUpload(props) {
  ...
  var _useContext = React.useContext(DropZoneContext),
...
var DropZone = function DropZone(_ref) {
  ...
  var dragTargets = React.useRef([]);
  var adjustSize = React.useCallback(debounce(function () {
    if (!node.current) {
      return;
    }
  ...
  var _useState5 = React.useState('extraLarge'),
      _useState6 = _slicedToArray(_useState5, 2),
      size = _useState6[0],
  ...
  var i18n = useI18n();
  var getValidatedFiles = React.useCallback(function (files) {
    var acceptedFiles = [];
    var rejectedFiles = [];
  ...
  React.useEffect(function () {
    ...
    if (!dropNode) return;
    events.addEventListener(dropNode, 'drop', handleDrop);
    events.addEventListener(dropNode, 'dragover', handleDragOver);
    events.addEventListener(dropNode, 'dragenter', handleDragEnter);
    events.addEventListener(dropNode, 'dragleave', handleDragLeave);
    events.addEventListener(window, 'resize', adjustSize);
    return function () {
      events.removeEventListener(dropNode, 'drop', handleDrop);
      events.removeEventListener(dropNode, 'dragover', handleDragOver);
      events.removeEventListener(dropNode, 'dragenter', handleDragEnter);
      events.removeEventListener(dropNode, 'dragleave', handleDragLeave);
      events.removeEventListener(window, 'resize', adjustSize);
    };
  ...
  _createClass(DropZoneInput, [{
    ...
    value: function render() {
      var _a = this.props,
          ...
          inputProps = tslib.__rest(_a, ["openFileDialog", "onFileDialogClose"]);
...
function EmptyState(_ref) {
  ...
  var className = classNames(styles$P.EmptyState, newLayout && styles$P.centeredLayout, imageContained && styles$P.imageContained, withinContentContainer ? styles$P.withinContentContainer : styles$P.withinPage);
...
var Focus = React.memo(function Focus(_ref) {
  var children = _ref.children,
      disabled = _ref.disabled,
      root = _ref.root;
  React.useEffect(function () {
...
function Sheet(_ref) {
  ...
  var findDOMNode = React.useCallback(function () {
...
var FiltersInner = /*#__PURE__*/function (_React$Component) {
  ...
  function FiltersInner() {
    ...
    _this.moreFiltersButtonContainer = React.createRef();
    _this.focusNode = React.createRef();
    ...
    _this.closeFilters = function () {
      _this.setState({
        ...
        if (_this.moreFiltersButtonContainer.current) {
          focus.focusFirstFocusableNode(_this.moreFiltersButtonContainer.current, false);
        }
      });
    };
...
var FormLayout = React.memo(function FormLayout(_ref) {
  var children = _ref.children;
  return /*#__PURE__*/React__default.createElement("div", {
...
var ToastManager = React.memo(function ToastManager(_ref) {
...
function redirectAction(target, external) {
  ...
  return actions.Redirect.Action[target];
}
...
function pick(obj) {
  ...
  return flattenedKeypaths.reduce(function (acc, key) {
    if (typeof key !== exports.TypeOf.String || Object.prototype.hasOwnProperty.call(obj, key)) {
...
function Dialog(_a) {
  var instant = _a.instant,
      ...
      props = tslib.__rest(_a, ["instant", "labelledBy", "children", "onClose", "onExited", "onEntered", "large", "limitHeight"]);
...
var getUniqueID$1 = other.createUniqueIDFactory('modal-header');
...
var ModalInner = /*#__PURE__*/function (_React$Component) {
  ...
  function ModalInner() {
    ...
    _this.handleExited = function () {
      ...
      _this.focusReturnPointNode && fastdom.write(function () {
        return _this.focusReturnPointNode && _this.focusReturnPointNode instanceof HTMLElement && focus.focusFirstFocusableNode(_this.focusReturnPointNode, false);
      });
    };
  ...
  _createClass(ModalInner, [{
    ...
    value: function componentDidMount() {
      ...
      if (transformProps) {
        this.appBridgeModal = actions.Modal.create(this.props.polaris.appBridge, transformProps);
      }
      ...
      if (open) {
        ...
        this.appBridgeModal && this.appBridgeModal.dispatch(actions.Modal.Action.OPEN);
      }
    }
  }, {
    key: "componentDidUpdate",
...
function ContextualSaveBar$1(_ref) {
  ...
  var handleDiscardAction = React.useCallback(function () {
...
function CSSAnimation(_ref) {
  ...
  var _useState = React.useState(inProp ? TransitionStatus$1.Entering : TransitionStatus$1.Exited),
      _useState2 = _slicedToArray(_useState, 2),
...
var FrameInner = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function FrameInner() {
    ...
    _this.navigationNode = React.createRef();
...
var Loading$1 = React__default.memo(function Loading() {
  var appBridgeLoading = React.useRef();
  var appBridge = useAppBridge();
  ...
  React.useEffect(function () {
    if (appBridge == null) {
      ...
      appBridgeLoading.current = actions.Loading.create(appBridge);
      appBridgeLoading.current.dispatch(actions.Loading.Action.START);
    }
    ...
    return function () {
      if (appBridge == null) {
        ...
        appBridgeLoading.current && appBridgeLoading.current.dispatch(actions.Loading.Action.STOP);
      }
    };
...
function Item$7(_ref) {
  ...
  var itemContentMarkup = /*#__PURE__*/React__default.createElement(React.Fragment, null, iconMarkup, /*#__PURE__*/React__default.createElement("span", {
...
function Section$5(_ref) {
  ...
  var itemsMarkup = items.map(function (item) {
    var onClick = item.onClick,
        ...
        rest = tslib.__rest(item, ["onClick", "label", "subNavigationItems"]);
...
function Tooltip(_ref) {
  ...
  React.useEffect(function () {
    var firstFocusable = activatorContainer.current ? focus.findFirstFocusableNode(activatorContainer.current) : null;
...
function Title(_ref) {
  ...
  var titleMarkup = title ? /*#__PURE__*/React.createElement("div", {
    className: styles$1h.Title
  }, /*#__PURE__*/React.createElement(DisplayText, {
    size: "large",
    element: "h1"
  }, title)) : null;
  var titleMetadataMarkup = titleMetadata ? /*#__PURE__*/React.createElement("div", {
    className: classNames(styles$1h.TitleMetadata, newDesignLanguage && styles$1h.newDesignLanguage)
  }, titleMetadata) : null;
  var wrappedTitleMarkup = titleMetadata ? /*#__PURE__*/React.createElement("div", {
    className: styles$1h.TitleWithMetadataWrapper
  }, titleMarkup, titleMetadataMarkup) : titleMarkup;
  var subtitleMarkup = subtitle ? /*#__PURE__*/React.createElement("div", {
    className: styles$1h.SubTitle
  }, /*#__PURE__*/React.createElement("p", null, subtitle)) : null;
  var thumbnailMarkup = thumbnail ? /*#__PURE__*/React.createElement("div", null, thumbnail) : null;
...
function Header$2(_ref) {
  ...
  var primaryActionMarkup = primaryAction ? /*#__PURE__*/React__default.createElement(ConditionalWrapper, {
...
function determineLayout(_ref2) {
  var breadcrumbMarkup = _ref2.breadcrumbMarkup,
      pageTitleMarkup = _ref2.pageTitleMarkup,
      title = _ref2.title,
      paginationMarkup = _ref2.paginationMarkup,
      actionMenuMarkup = _ref2.actionMenuMarkup,
      primaryActionMarkup = _ref2.primaryActionMarkup,
      isNavigationCollapsed = _ref2.isNavigationCollapsed;
  var shortTitle = 20;
...
var PageInner = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(PageInner, [{
    ...
    value: function componentDidMount() {
      ...
      this.titlebar = actions.TitleBar.create(this.props.polaris.appBridge, transformedProps);
    }
  }, {
    key: "componentDidUpdate",
    value: function componentDidUpdate(prevProps) {
    ...
    value: function render() {
      var _a = this.props,
          ...
          rest = tslib.__rest(_a, ["children", "fullWidth", "narrowWidth", "singleColumn"]);
  ...
  _createClass(DualThumb, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.trackWrapper.current != null) {
        events.addEventListener(this.trackWrapper.current, 'touchstart', this.handleTouchStartTrack, {
          passive: false
        });
      }
    }
    ...
    value: function componentWillUnmount() {
      if (this.trackWrapper.current != null) {
        events.removeEventListener(this.trackWrapper.current, 'touchstart', this.handleTouchStartTrack);
      }
    }
  }, {
    key: "render",
...
function registerMouseMoveHandler(handler) {
  events.addEventListener(document, 'mousemove', handler);
  events.addEventListener(document, 'mouseup', function () {
    events.removeEventListener(document, 'mousemove', handler);
  }, {
    once: true
  });
}
...
function registerTouchMoveHandler(handler) {
  var removeHandler = function removeHandler() {
    events.removeEventListener(document, 'touchmove', handler);
    events.removeEventListener(document, 'touchend', removeHandler);
    events.removeEventListener(document, 'touchcancel', removeHandler);
  };

  events.addEventListener(document, 'touchmove', handler, {
    passive: false
  });
  events.addEventListener(document, 'touchend', removeHandler, {
    once: true
  });
  events.addEventListener(document, 'touchcancel', removeHandler, {
    once: true
  });
}
...
function RangeSlider(_a) {
  var _a$min = _a.min,
      ...
      value = _a.value,
      rest = tslib.__rest(_a, ["min", "max", "step", "value"]);
...
var getUniqueOverlayID = other.createUniqueIDFactory('ResourceListItemOverlay');
  ...
  _createClass(BaseResourceItem, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      var nextChildren = nextProps.children,
          ...
          restNextContext = tslib.__rest(_a, ["selectedItems"]),
          restNextProps = tslib.__rest(nextProps, ["children", "context"]);

      var _b = this.props,
          children = _b.children,
          _c = _b.context,
          selectedItems = _c.selectedItems,
          restContext = tslib.__rest(_c, ["selectedItems"]),
          restProps = tslib.__rest(_b, ["children", "context"]);
...
function renderSingleOption(option) {
  var value = option.value,
      label = option.label,
      rest = tslib.__rest(option, ["value", "label"]);
...
var BulkActionsInner = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function BulkActionsInner() {
    ...
    _this.checkableWrapperNode = React.createRef();
    _this.largeScreenGroupNode = React.createRef();
    _this.smallScreenGroupNode = React.createRef();
...
var DateSelector = React.memo(function DateSelector(_ref) {
  ...
  var _useState = React.useState(now.getMonth()),
      _useState2 = _slicedToArray(_useState, 2),
      datePickerMonth = _useState2[0],
      setDatePickerMonth = _useState2[1];

  var _useState3 = React.useState(now.getFullYear()),
      _useState4 = _slicedToArray(_useState3, 2),
  ...
  var handleDateFieldChange = React.useCallback(function (value) {
    if (value.length === 0) {
  ...
  var handleDateChanged = React.useCallback(function (date) {
    if (!date) {
      return;
    }
  ...
  var handleDateBlur = React.useCallback(function () {
  ...
  var handleDateFilterOptionsChange = React.useCallback(function (newOption) {
  ...
  var handleDatePickerChange = React.useCallback(function (_ref2) {
  ...
  var handleDatePickerMonthChange = React.useCallback(function (month, year) {
...
function FilterValueSelector(_ref) {
  ...
  var operatorText = filter.operatorText,
      type = filter.type,
      label = filter.label;
  var showOperatorOptions = type !== exports.FilterType.DateSelector && operatorText && typeof operatorText !== 'string';
  var handleOperatorOptionChange = React.useCallback(function (operatorKey) {
...
function FilterCreator(_ref) {
  ...
  var handleButtonFocus = React.useCallback(function () {
  ...
  var handleFilterKeyChange = React.useCallback(function (filterKey) {
  ...
  var handleFilterValueChange = React.useCallback(function (value) {
    setSelectedFilterValue(value);
  }, []);
  var handleAddFilter = React.useCallback(function () {
...
var ResourceListInner = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(ResourceListInner, [{
    ...
    value: function render() {
      ...
      var showEmptySearchState = filterControl && !this.itemsExist() && !loading;
      var headerMarkup = !showEmptySearchState && (showHeader || needsHeader) && this.listRef.current && /*#__PURE__*/React__default.createElement("div", {
      ...
      var listMarkup = this.itemsExist() ? /*#__PURE__*/React__default.createElement("ul", {
        className: resourceListClassName,
        ref: this.listRef,
        "aria-live": "polite",
        "aria-busy": loading
      }, loadingOverlay, items.map(this.renderItem)) : emptySearchStateMarkup;
      var context = {
  ...
  _createClass(ResourcePickerInner, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      var prevAppBridge = prevProps.polaris.appBridge,
          prevResourcePickerProps = tslib.__rest(prevProps, ["polaris"]);

      var _a = this.props,
          appBridge = _a.polaris.appBridge,
          resourcePickerProps = tslib.__rest(_a, ["polaris"]);
      ...
      if (onSelection != null) {
        this.appBridgeResourcePicker.subscribe(actions.ResourcePicker.Action.SELECT, function (_ref2) {
  ...
  _createClass(List, [{
    ...
    value: function render() {
      ...
      var tabs = disclosureTabs.map(function (_a, index) {
        var id = _a.id,
            content = _a.content,
            tabProps = tslib.__rest(_a, ["id", "content"]);
...
var TabMeasurer = React.memo(function TabMeasurer(_ref) {
  ...
  var containerNode = React.useRef(null);
  var animationFrame = React.useRef(null);
  var handleMeasurement = React.useCallback(function () {
    if (animationFrame.current) {
      cancelAnimationFrame(animationFrame.current);
    }
...
var Toast$1 = React__default.memo(function Toast(props) {
  ...
  var appBridgeToast = React.useRef();
  ...
  useDeepEffect(function () {
    ...
    if (appBridge == null) {
      ...
      appBridgeToast.current = actions.Toast.create(appBridge, {
        message: content,
        duration,
        isError: error
      });
      appBridgeToast.current.subscribe(actions.Toast.Action.CLEAR, onDismiss);
      appBridgeToast.current.dispatch(actions.Toast.Action.SHOW);
    }
...
function SearchDismissOverlay(_ref) {
  ...
  var node = React.useRef(null);
  var handleDismiss = React.useCallback(function (_ref2) {
    var target = _ref2.target;
...
exports.AppBridgeContext = AppBridgeContext;
