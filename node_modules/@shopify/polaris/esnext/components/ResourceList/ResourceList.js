...
class ResourceListInner extends React.Component {
    ...
    // eslint-disable-next-line @typescript-eslint/member-ordering
    render() {
        const { items, promotedBulkActions, bulkActions, filterControl, loading, showHeader = false, sortOptions, sortValue, alternateTool, selectedItems, resourceName = this.defaultResourceName, onSortChange, emptySearchState, polaris: { intl }, } = this.props;
        ...
        const showEmptySearchState = filterControl && !this.itemsExist() && !loading;
